...
class template{
        ...
        function addTemplateI($template_file){
                $this->tpl_file = 'config/templates/' . $template_file . '.htm';				
		...
		function getNontemplate($template_file){
		     $this->tpl_file = 'tickets/' . $template_file . '.php';
			 return $this->agrega();
		}
